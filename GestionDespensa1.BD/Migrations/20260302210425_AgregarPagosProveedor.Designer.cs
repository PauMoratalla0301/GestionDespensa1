...
namespace GestionDespensa1.BD.Migrations
{
    ...
    [Migration("20260302210425_AgregarPagosProveedor")]
    partial class AgregarPagosProveedor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompraProveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DetalleCompraProveedor", b =>
                {
                    b.HasOne("CompraProveedor", "CompraProveedor")
            ...
            modelBuilder.Entity("GestionDespensa1.BD.Data.Entity.PagoProveedor", b =>
                {
                    b.HasOne("CompraProveedor", "Compra")
                        .WithMany()
                        .HasForeignKey("IdCompra")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
